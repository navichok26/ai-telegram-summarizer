...
def build_prompt(chat_payload: dict[str, Any], max_topics: int) -> str:
    ...
    return (
        "Ты анализируешь JSON с сообщениями из Telegram-чата и выделяешь основные темы обсуждения.\n"
        "Стиль формулировок: гик-студент, ироничный, живой.\n"
...
def build_topic_merge_prompt(batch_topics: list[dict[str, Any]]) -> str:
    ...
    return (
        ...
        "Стиль формулировок: гик-студент, ироничный, но читабельный.\n"
        "Правила:\n"
